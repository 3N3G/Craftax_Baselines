...
- model: `/data/group_data/rl/geney/model_mirrors/Qwen3.5-9B`
...
- vllm_model_id: `/data/group_data/rl/geney/model_mirrors/Qwen3.5-9B`
...
- vllm_enable_hybrid_kv_cache_manager: `True`
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| /data/group_data/rl/geney/model_mirrors/Qwen3.5-9B | predict_history_k5 | 1 | 1 | 0 | 0.5662 | 1.7660 | 0.5667 | 1.7646 | 6436.0 | 1.0 | 6437.0 |
| /data/group_data/rl/geney/model_mirrors/Qwen3.5-9B | predict_state_only | 1 | 0 | 1 |  |  |  |  |  |  |  |
